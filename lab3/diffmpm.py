...
#     seg_heights[i] = random.randint(min_segh, int(max_segh))
#     max_segh = seg_heights[i]
#
...
def snake(scene):
    ...
    scene.add_rect(0.0, 0.1, seg_width, head_height, -1)  # head
    for i in range(num_segs):
        scene.add_rect((i+1)*seg_width, 0.0, seg_width, head_height - 0.01*i, i)
