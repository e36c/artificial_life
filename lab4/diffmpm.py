...
def snake(scene):
    scene.set_offset(0.1, head_height)
    scene.add_rect(0.0, 0.0, seg_width, head_height, -1)  # head
    for i in range(num_segs):
        scene.add_rect((i+1)*seg_width, 0.0, seg_width, seg_heights[i], i)
        # scene.add_rect((i+1)*seg_width, 0.0, seg_width, seg_heights[i], i)
    # scene.add_rect(1*seg_width, 0.0, seg_width, seg_heights[0], 0)  # seg1
    # scene.add_rect(2*seg_width, 0.0, seg_width, seg_heights[0], 1) # seg2
    # scene.add_rect(3*seg_width, 0.0, seg_width, seg_heights[0], 2)  # seg3
    # scene.add_rect(4*seg_width, 0.0, seg_width, seg_heights[0], 3) # seg4
    scene.set_n_actuators(4)
